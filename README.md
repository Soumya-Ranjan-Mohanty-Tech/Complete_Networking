...
**1)** **Devices**(Anything with a chip and a connection)-Laptop has IP address like phone, server. Cables or WiFi Signals. Data travelling the network. When devices can talk to each other then it is a network.
